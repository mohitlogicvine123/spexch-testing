  ...
  return (
    <div  className="md:mx-0 mx-2 sm:mt-5 mt-3 border border-gray-300 rounded-[5px] overflow-hidden bg-white">
      ...
      <div className="md:p-4 p-3">
        ...
        <div className="flex sm:flex-row flex-col items-end justify-between sm:gap-6 gap-4 mb-4">
          {/* Select Session Dropdown */}
          <div className="sm:w-auto w-full">
            <label
              htmlFor="session"
              className="block font-bold text-sm text-gray-900 mb-1 text-left"
            >
              Select Session
            </label>
            <select
              ...
              id="session"
              className="px-2 text-sm py-2 border border-gray-300 rounded outline-none w-full"
            >
        ...
        {location?.pathname?.includes('/AllSessionListRevert') ? 
          <div className=" flex" onClick={()=>setRemarkModal2(true)}>
            <button disabled={checkbox?.length == 0 ? true : false} className="bg-gradient-seablue text-sm disabled:bg-sky-300 py-2 max-w-32 px-4 rounded-md text-white w-full font-semibold">
              Revert Bets
              </button>
          </div>
          :
          <div className="w-full flex " onClick={()=>setRemarkModal(true)}>
            <button disabled={checkbox?.length == 0 ? true : false} className="bg-red-500 text-sm disabled:bg-red-200 py-2 max-w-32 px-4 rounded-md text-white w-full font-semibold">
              Delete Bets
              </button>
          </div>}
