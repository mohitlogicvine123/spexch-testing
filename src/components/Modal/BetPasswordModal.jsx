...
const BetPasswordModal = ({ userId, onCancel }) => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 flex items-start justify-center bg-gray-500 bg-opacity-50 z-50">
      <div className="bg-white rounded-[5px] overflow-hidden sm:w-[500px] w-[96%] sm:mt-12 mt-3">
        ...
        <div className="p-4">
          <div className="grid md:grid-cols-2 sm:gap-6 gap-3">
            <div>
              <label className="text-[13px] font-custom font-medium text-gray-700">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-2 border border-gray-300 rounded h-[35px] mt-1"
                />
                <span
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-2 border h-[35px] border-gray-300 rounded mt-1"
                />
                <span
                  onClick={() => setShowNewPassword(!showNewPassword)}
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 cursor-pointer text-blue"
              ...
              {error && <div className="text-red-600 text-[13px] mt-1">{error}</div>}
            </div>
            <div>
              <label
                className="text-[13px] font-custom font-medium text-gray-700"
          ...
          <div className="flex justify-end mt-7 space-x-2">
            <button
              ...
              className={`bg-gradient-seablue text-[14px] text-white font-bold font-custom px-2 py-2 rounded ${
                !currentPassword ||
                !newPassword ||
                !confirmPassword ||
            ...
            <button
              onClick={onCancel}
              className="bg-gradient-seablue text-[14px] text-white px-3 py-2 rounded font-bold font-custom"
